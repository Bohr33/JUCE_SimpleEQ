...
SimpleEQAudioProcessor::createParameterLayout(){
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("LowCut Freq",
                                                           "LowCut Freq",
                                                           juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 0.25)
                                                           , 20.f));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Gain",
                                                          "Peak Gain",
                                                          juce::NormalisableRange<float>(-24.f, 24.f, 0.5f, 1.),
                                                          0.0f));
    ...
    //creates a string Array and then creates the 4 options for filter slopes and adds them into the array using for loop
